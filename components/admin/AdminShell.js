...
// Design tokens — same white/black/red minimalist system as the rest of the site.
const INK = '#000000';
          ...
          {NAV.map(({ href, label, icon: Icon }) => {
            ...
            return (
              <Link
                ...
                style={{
                  borderRadius: '4px',
                  background: active ? RED_WASH : 'transparent',
                  color: active ? RED : INK_SOFT,
                }}
                onMouseEnter={(e) => {
                  if (!active) {
                    e.currentTarget.style.background = RED_WASH;
