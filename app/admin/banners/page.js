    ...
    <div>
      ...
      {showForm && (
        <form onSubmit={submit} className="card-soft p-5 mb-6 space-y-3">
          ...
          {/* Image upload — single image, used responsively on the storefront */}
          <div>
            ...
            <p className="text-xs text-brand-ink/40 mt-1">
              Recommended: wide crop, ~2.4:1 ratio. Keep the main subject centered — it will be
              cropped automatically to fit mobile and desktop screens.
            </p>
          </div>
