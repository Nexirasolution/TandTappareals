    ...
    <div className="max-w-2xl mx-auto p-8 sm:p-10" style={{ background: PAPER, color: INK }}>
      <div className="flex justify-between items-start pb-5 mb-6" style={{ borderBottom: `1px solid ${LINE}` }}>
        ...
        <div className="text-right">
          <h2 className="text-[11px] font-medium uppercase tracking-[0.18em]" style={{ color: RED }}>Invoice</h2>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8 text-sm">
        <div>
          <p className="text-[11px] font-medium uppercase tracking-[0.18em] mb-2" style={{ color: RED }}>Billed To</p>
        ...
        <div>
          <p className="text-[11px] font-medium uppercase tracking-[0.18em] mb-2" style={{ color: RED }}>Payment</p>
      ...
      <table className="w-full text-sm border-collapse mb-8">
        <thead>
          <tr style={{ borderBottom: `1px solid ${LINE}` }} className="text-left">
            <th className="py-2.5 text-[11px] font-medium uppercase tracking-[0.1em]" style={{ color: RED }}>Item</th>
            <th className="py-2.5 text-[11px] font-medium uppercase tracking-[0.1em]" style={{ color: RED }}>Color/Size</th>
            <th className="py-2.5 text-right text-[11px] font-medium uppercase tracking-[0.1em]" style={{ color: RED }}>Price</th>
            <th className="py-2.5 text-right text-[11px] font-medium uppercase tracking-[0.1em]" style={{ color: RED }}>Qty</th>
            <th className="py-2.5 text-right text-[11px] font-medium uppercase tracking-[0.1em]" style={{ color: RED }}>Total</th>
          </tr>
        </thead>
        <tbody>
      ...
      <div className="flex justify-end">
        <div className="w-56 text-sm space-y-1.5">
          ...
          <div className="flex justify-between text-base pt-2 mt-1" style={{ color: RED, borderTop: `1px solid ${LINE}`, fontFamily: FONT_SERIF }}>
