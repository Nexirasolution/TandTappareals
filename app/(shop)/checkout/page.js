    ...
    <div className="max-w-4xl mx-auto px-5 sm:px-8 py-8 sm:py-14" style={{ background: PAPER }}>
      ...
      {freeShippingAbove !== null && shipping !== null && shipping > 0 && (
        <div
          ...
          style={{ background: RED_LIGHT, color: INK_SOFT, borderRadius: '3px' }}
        >
          Add <strong style={{ color: RED }}>{formatINR(freeShippingAbove - discountedSubtotal)}</strong> more to get{' '}
          <strong style={{ color: ACCENT_DARK }}>free shipping</strong>
        </div>
      )}
      ...
      <div className="flex flex-col gap-8 sm:grid sm:grid-cols-2 sm:gap-12">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div>
            ...
            {/* <div className="flex gap-2 mt-4">
              ...
              <button
                ...
                style={{ border: `1px solid ${RED}`, color: RED, background: PAPER, borderRadius: '3px' }}
              >
                Apply
              </button>
            </div> */}
              ...
              <div className="flex justify-between" style={{ color: INK_SOFT }}>
                ...
                <span>
                  {shippingLoading
                    ...
                    : shipping === 0
                      ? <span style={{ color: ACCENT_DARK, fontWeight: 600 }}>Free</span>
                      : shipping !== null
                        ? formatINR(shipping)
            ...
            <div className="flex justify-between mt-3 pt-3 text-base" style={{ borderTop: `1px solid ${LINE}` }}>
              ...
              <span style={{ color: RED, fontFamily: FONT_SERIF }}>{total !== null ? formatINR(total) : '—'}</span>
            </div>
          </div>
          ...
          <button
            ...
            style={{
              background: placeOrderDisabled ? '#F0A9B0' : RED,
              color: PAPER,
              borderRadius: '4px',
            }}
          >
