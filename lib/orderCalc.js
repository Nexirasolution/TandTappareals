...
export async function buildOrderItemsAndTotals(items, couponCode) {
  ...
  if (!settings) throw new OrderError('Store settings not configured');

  // totalQty must match exactly what the checkout page sends to
  // /api/admin/settings for the shipping preview: sum of each line's qty.
