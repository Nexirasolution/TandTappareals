  ...
  if (items.length === 0) {
    return (
      <div className="max-w-md mx-auto px-5 py-24 text-center" style={{ background: PAPER }}>
        <ShoppingBag size={28} strokeWidth={1.5} className="mx-auto mb-4" style={{ color: RED, opacity: 0.6 }} />
      ...
      <div className="space-y-0">
        {items.map((item, idx) => {
          ...
          return (
            ...
            >
              {/* Product image */}
              <div className="relative shrink-0 w-16 h-20 sm:w-20 sm:h-24 overflow-hidden" style={{ background: RED_WASH, borderRadius: '3px' }}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm mt-1.5" style={{ color: RED }}>{formatINR(item.price)}</p>
