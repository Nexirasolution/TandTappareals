...
// Design tokens — shared minimalist black / red / white theme
const COFFEE = '#000000';
const COFFEE_FAINT = '#6E6E6E';
  ...
  <section className="max-w-6xl mx-auto px-4 pt-14 pb-6">
    ...
    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4 sm:gap-6">
      ...
      <section className="max-w-6xl mx-auto px-4 pt-16 pb-16 text-center">
        ...
        <Link
          href="/products"
          className="inline-block mt-10 px-8 py-3  text-[12px] font-bold tracking-[2px] uppercase transition-colors bg-[#FBE9EB] hover:bg-[#F5C2CB]"
          style={{ color: COFFEE, fontFamily: FONT_SANS }}
        >
          Shop the collection
        </Link>
